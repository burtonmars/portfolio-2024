  ...
  return (
    <div className='flex flex-col justify-center h-full max-w-full w-full md:w-5/6'>
        <div className="card-body flex flex-col justify-center items-center gap-6">
            ...
            <h3 className='text-center text-xl xxl:text-2xl'>I am a passionate developer and life-long learner who strives to combine best software design practices with innovative and creative solutions.</h3>
            <Link className='btn btn-primary btn-lg mt-6 text-black' href={'#projects'}>My Work</Link>  
        </div>
    </div>
  )
}
